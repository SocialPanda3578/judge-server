...
from services.java import check_java, compile_java
from minio.error import S3Error


def judge_java(code: str, pid: str,client: Minio):
    max_run_time = 0
    max_memory_usage = 0
    testcase_count = 0
    ...
    result_queue = ''
    # compile
    compile_result = compile_java.compile_java(code)  # 提交编译
    ...
    try:
        ...
        try:
            ...
            for obj in objects:  # 遍历 { 测试点文件夹 }/IN
                ...
                result = check_java.check(std_input_file_data, std_output_file_data, 1000, 10000000)  # 提交测试
